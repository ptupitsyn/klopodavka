...
namespace Clops.Ai.Algo
{
    ...
    public class a_star
    {
        ...
        public delegate double GetDist(IClopNode n1, IClopNode n2);
        //public GetDist Dist;

        public delegate IClopNode GetNodeByXY(int x, int y);
        //public GetNodeByXY NodeXY;

        public IClopNode FindPath(IClopNode s, IClopNode f, GetDist Dist, GetNodeByXY NodeXY)
        {
            //Some checks
